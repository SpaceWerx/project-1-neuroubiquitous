...
import com.revature.models.RbType;
...
public void displayMenu() {
	...
	boolean menuOptions = true;	
		...
		System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
		System.out.println("~~ Welcome to Revature's Reimbursement Entry System ~~~~");
		System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
		System.out.println();
	...
	while(menuOptions) {
		System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
		System.out.println("~~~~~~ Select your reimbursement type below ~~~~~~~~~~~~~~");
...
public void submitReimbursement(User Employee) {
	...
	////Food, Lodging, Travel, Conference, Education, Tool, Other,
	System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
	...
	System.out.println("6 -> Tool");
	System.out.println("7 -> Other");
	
	
	int typeDecision = promptSelection(1,2,3,4,5,6,7);
	
	switch (typeDecision) {
	case 1:
		reimbursementToBeSubmitted.setType(RbType.Food);
		break;
	case 2:
		reimbursementToBeSubmitted.setType(RbType.Lodging);
		break;
	case 3:
		reimbursementToBeSubmitted.setType(RbType.Travel);
		break;
	case 4:
		reimbursementToBeSubmitted.setType(RbType.Conference);
		break;
	case 5:
		reimbursementToBeSubmitted.setType(RbType.Education);
		break;
	case 6:
		reimbursementToBeSubmitted.setType(RbType.Tool);
		break;
	case 7:
		reimbursementToBeSubmitted.setType(RbType.Other);
		break;
	}
